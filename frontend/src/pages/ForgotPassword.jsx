...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage("If that email is registered, we have sent a reset link to it. Check your inbox.");
    } catch (err) {
    ...
    <div className="w-full h-screen overflow-hidden flex flex-col md:flex-row bg-[#F8F5EF] font-sans antialiased text-[#171717] selection:bg-[#D97745]/10 selection:text-[#D97745] relative">
      ...
      <div className="hidden md:flex md:w-[55%] relative flex-col pt-12 px-12 lg:px-20 pb-8 z-10 h-full">
        ...
        <div className="flex flex-col justify-center max-w-[500px]">
          ...
          >
            Lost your key? <br className="hidden lg:block" />
            <span className="text-[#D97745]">We'll help you find it.</span>
          </motion.h1>
          ...
          >
            It happens to the best of us. Just enter your email and we'll securely guide you back to your workspaces.
          </motion.p>
        </div>
        ...
        >
          ...
          {successMessage ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-left w-full mb-6">
              <div>
                <label className="block text-[11px] font-black text-[#A0A09A] uppercase tracking-wider mb-1.5 ml-1">Email Address</label>
                <input 
                  type="email" 
                  value={email} 
                  onChange={e => {
