    ...
    <div className="w-full h-screen overflow-hidden flex flex-col md:flex-row bg-[#F8F5EF] font-sans antialiased text-[#171717] selection:bg-[#D97745]/10 selection:text-[#D97745] relative">
      ...
      <div className="w-full md:w-[45%] h-full relative flex items-center justify-center p-6 z-20 overflow-y-auto">
        ...
        >
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4 text-left w-full mb-6">
            <div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5 px-1">
                <label className="block text-[11px] font-black text-[#A0A09A] uppercase tracking-wider">Password</label>
                <Link to="/forgot-password" className="text-[11px] font-black text-[#D97745] hover:underline">Forgot?</Link>
              </div>
              <input 
                type="password" 
                value={password} 
          ...
          <p className="text-[13px] text-[#7A7870] font-medium">
            New to Notely?{' '}
            <Link to="/register" className="text-[#D97745] font-bold hover:underline underline-offset-2">
