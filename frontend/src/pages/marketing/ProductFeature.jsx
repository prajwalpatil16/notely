...
const featureData = {
  ...
  "search": {
    seoTitle: "Full-Text Search & Discovery | Notely",
    seoDescription: "Fast full-text search across every note instantly. Find what you need, when you need it.",
    icon: IconSearch,
    themeColor: "#171717",
    tag: "SEARCH",
    heroHeading: "Find knowledge instantly.",
    heroDesc: "Fast full-text search across every note. Locate any meeting, idea, or document instantly without slow substring lookups.",
    primaryCta: "Try Search",
    secondaryCta: "See how it works",
    sectionTitle: "Search that actually works",
    sectionSubtitle: "Find information the way you think about it, indexed for speed.",
    bullets: [
      "Fast full-text search",
      "Highly optimized keyword ranking",
    ...
    useCases: [
      { title: "Fast index search", desc: "Instantly query titles and contents." },
